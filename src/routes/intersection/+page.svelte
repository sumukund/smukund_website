<script lang="ts">
    ...
    import { intersectionCapstone } from '$lib/data/intersection';
</script>
...
<div class="page">
    <main>
        ...
        <section class="metadata-grid">
            ...
            <div><strong>Medium:</strong> Multimedia and performance art presentation</div>
            <div><strong>Dimensions:</strong> 20ft × 25ft × 8ft minimum room dimensions</div>
        </section>
        ...
        <section class="context-box">
            <p>
                In December 2025, Operation Metro Surge began in earnest in Minneapolis. Immigration enforcement actions escalated with the deployment of 4,000 ICE agents to the Twin Cities and rural Minnesota. ICE occupation in the Twin Cities has affected both documented and undocumented people. Innocent civilians have been detained by ICE agents and subjected to unlawful and unconstitutional actions.
            </p>
        </section>
...
<style>
    ...
    /* Contributions and Technical Styling */
    ul {
        padding-left: 1.2rem;
        margin-bottom: 1.5rem;
    }
