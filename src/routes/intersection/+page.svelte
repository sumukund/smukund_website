...
.image-grid {
  ...
  .image-container {
    width: 100%;
    height: 180px; /* Adjust this number to make the thumbnails smaller or larger */
    background: #f0ebe1; /* Optional: adds a subtle background for transparent/letterboxed images */
    display: flex;
    align-items: center;
    justify-content: center;
    border-radius: 2px;
